...
[[nodiscard]] VectorTokenPtr::iterator evaluate_subscript_sanity(VectorTokenPtr::iterator it, VectorTokenPtr::iterator& end, expression_context& context)
{
...
[[nodiscard]] VectorTokenPtr::iterator  evaluate_function_call_sanity(VectorTokenPtr::iterator it, VectorTokenPtr::iterator& end, [[maybe_unused]] expression_context& context)
{
	//check the next token
	if (VECTOR_PEEK(it, 1, end) == false) {
		throw linting_error("no way\n");
